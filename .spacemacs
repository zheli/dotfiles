...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(ensime
                                    lsp-python-ms ; I don't want ms lsp-py
                                    )
