...
** Org
   #+begin_src emacs-lisp :results none
     ...
     (setq org-agenda-files (list "~/Dropbox/inbox.org"
                                  "~/Dropbox/schedule_private.org"
                                  "~/Dropbox/schedule_work.org"))
     ...
     (setq org-capture-templates '(("t" "Todo [inbox]" entry
                                   ...
                                   ("T" "Tickler" entry
                                    ...
                                    "* %i%? \n %U")))
     (setq org-refile-targets '(("~/Dropbox/gtd.org" :maxlevel . 3)
...
*** Google Calendar
    #+begin_src emacs-lisp :results none
      (setq org-gcal-file-alist
            '(
              ("linuxcity.jn@gmail.com" . "~/Dropbox/schedule_private.org")
              ("zhe@minna.tech" . "~/Dropbox/schedule_work.org")))
